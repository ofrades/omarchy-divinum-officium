...
Panel {
  ...
  // Which hours to read from a private API; empty means every hour, and the
  // mirror answers whenever the API cannot.
  readonly property string apiHours: String(setting("apiHours", "")).trim()
